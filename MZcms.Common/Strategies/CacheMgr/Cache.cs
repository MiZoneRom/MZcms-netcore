...
namespace MZcms.Common
{
    ...
    public static class Cache
    {
        ...
        /// <summary>
        /// 获得指定键的缓存值(注意获取redis缓存时可能会存在问题,一定要明确返回类型)
        /// </summary>
        ...
        #region 缓存到本地System.Web.Caching.Cache

        /// <summary>
        /// 缓存到本地System.Web.Caching.Cache
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="key">用于引用该对象的缓存键</param>
        /// <param name="data">要插入缓存中的对象</param>
        /// <param name="cacheTime">缓存过期时间(秒)</param>
        public static void InsertLocal<T>(string key, T data, int cacheTime)
        {
            MZcms.Common.Helper.CacheHelper.Insert(key, data, cacheTime);
        }

        /// <summary>
        /// 从本地System.Web.Caching.Cache缓存中获取对象
        /// </summary>
        /// <typeparam name="T">数据类型</typeparam>
        /// <param name="key">用于引用该对象的缓存键</param>
        /// <returns>对象</returns>
        ...
        {
            return MZcms.Common.Helper.CacheHelper.Get<T>(key);
        }
